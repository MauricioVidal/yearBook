...
class VisitaControllerTest < ActionController::TestCase
  ...
  test "should create visitum" do
    assert_difference('Visitum.count') do
      post :create, visitum: { current_user_id: @visitum.current_user_id, user_visited_id: @visitum.user_visited_id }
    end
  ...
  test "should update visitum" do
    patch :update, id: @visitum, visitum: { current_user_id: @visitum.current_user_id, user_visited_id: @visitum.user_visited_id }
    assert_redirected_to visitum_path(assigns(:visitum))
  end
